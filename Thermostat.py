...
class TemperatureMachine(StateMachine):
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            line_1 = current_time.strftime("%m/%d %H:%M:%S") + "\n"
            
            ## Setup Display Line 2
            if(altCounter < 6):
                line_2 = f"Temp: {floor(self.getFahrenheit())}F"

                altCounter = altCounter + 1
            else:
                line_2 = f"{self.current_state.id} Set:{self.setPoint}F"
...
##
## Configure our Blue button to use GPIO 24 and to execute
...
##
## Configure our Green button to use GPIO 12 and to execute
